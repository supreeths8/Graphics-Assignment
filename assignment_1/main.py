...
def test_rendering(_source, coordinates: ViewPortCoordinates, shade_type: ShadeType, rw):
    """
    Render the STL object in the view port of the render window using the
    `coordinates` object and the `shading` type
    :param _source: Object to render
    :param coordinates: ViewPortCoordinates to specify the viewport in the
    render window
    ...
    ren.SetViewport(coordinates.x_min, coordinates.y_min, coordinates.x_max,
    coordinates.y_max)
